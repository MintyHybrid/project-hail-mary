...
- The flanking regions of the sequences matching a DNAzyme catalytic domain in the viral genomes (16 sequences or isolates in total, among which 9 are identical by sequence) are identical to regions in the genomes of several eukaryotes, including plants (potential viral hosts) and insects (potential viral vectors).
...
4. **Caveat — this is not yet established.** It is *not* shown that the
   ...
   potyvirus. I built the **BioNexus** app (Chapter 8) to test connectivity; the
   interactions looked **sporadic rather than continuous** — which is *not* enough
