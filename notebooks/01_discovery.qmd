...
6. **The locus is the CI gene.** The DNAzyme-like sequence maps to the coding region
   of the **cylindrical inclusion (CI)** protein (Chapters 2–4).

**Where this goes.** Assessing potential catalytic activity (Chapter 3) shows most
homologs carry **substitutions at activity-critical core positions**, so DNAzyme
activity is **unlikely / rare** — and would additionally require reverse
...
DNAzyme published by @borggraefe2022, which is a paper about a
